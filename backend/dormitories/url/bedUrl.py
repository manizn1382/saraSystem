...
from dormitories.view.BedViews import BedListView, BedCreateView, BedDetailView, BedUpdateView

urlpatterns = [

    path('listAll/', BedListView.as_view(), name='Bed-list'),
    path('listAll/<str:status>', BedListView.as_view(), name='Bed-list-by-status'),
