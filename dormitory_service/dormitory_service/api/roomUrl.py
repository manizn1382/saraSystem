...
from dormitory_service.view.RoomViews import RoomListView, RoomCreateView, RoomDeleteView, RoomUpdateView
from dormitory_service.view.BedViews import RoomBedsListView
